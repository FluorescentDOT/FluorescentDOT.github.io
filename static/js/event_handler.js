document.addEventListener('DOMContentLoaded', domReady);
        ...
        function ablation3DEvent(idx) {
            ...
            let imagesLength = 2
            for (let i = 0; i < imagesLength; i++) {
                let image = sections[i].getElementsByClassName('b-dics__image-container')[0].getElementsByClassName('b-dics__video')[0]
                switch (idx) {
                    case 0:
                        image.src = 'resources/cloth';
                        break;
                    case 1:
                        image.src = 'resources/web_img/rope/frame000002';
                        break;
                    case 2:
                        image.src = 'resources/web_img/rope/frame000003';
                        break;
                    case 3:
                        image.src = 'resources/web_img/rope/frame000004';
                        break; 
                    case 4:
                        image.src = 'resources/web_img/rope/frame000005';
                        break;
                    case 5:
                        image.src = 'resources/web_img/rope/frame000006';
                        break; 
                }
                switch (i) {
                    case 0:
                        image.src = image.src + '_cam032.mp4';
                        break;
                    case 1:
                        image.src = image.src + '_cam033.mp4';
                        break;
                }
                // switch (idx) {
                //     case 0:
